<div wire:poll.3s="refreshData">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$tournament): ?>
        <div class="container" style="text-align: center; padding: 6rem 0;">
            <div style="font-size: 4rem; margin-bottom: 1rem;">🏆</div>
            <h2><?php echo e(__('Belum Ada Turnamen')); ?></h2>
        ...
        <section class="hero" style="padding: 4rem 1rem 3rem;">
            <div class="container" style="position: relative; z-index: 2;">
                <div style="display: inline-flex; align-items: center; gap: 0.5rem; background: rgba(57, 211, 83, 0.1); border: 1px solid rgba(57, 211, 83, 0.2); padding: 0.35rem 1rem; border-radius: 20px; margin-bottom: 1.5rem; font-size: 0.85rem; font-weight: 700; color: var(--primary); text-transform: uppercase; letter-spacing: 0.5px;">
                    ...
                    <?php echo e($tournament->status); ?>

                </div>
                <h1 style="font-size: 3.5rem; font-weight: 900; letter-spacing: -1.5px; margin-bottom: 0.75rem; line-height: 1.1;">
                    <span class="gradient-text" style="background: linear-gradient(135deg, var(--primary) 0%, #00ffcc 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;"><?php echo e($tournament->name); ?></span>
                </h1>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tournament->status === 'registration'): ?>
        ...
        <div class="container">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); margin-bottom: 3rem; gap: 1.75rem;">
                ...
                <div class="glass-card">
                    <h3 class="card-title" style="color: var(--primary); font-size: 1.25rem; font-weight: 800; display: flex; align-items: center; gap: 0.5rem; margin-bottom: 1rem;">
                        📜 <?php echo e(__('Tournament Rules')); ?>
                    ...
                    <div class="soft-well" style="color: var(--text-muted); max-height: 180px; overflow-y: auto; font-size: 0.9rem; line-height: 1.6; border-radius: 8px;">
                        <?php echo $tournament->rules_content ?: 'Peraturan standard eFootball / PES.'; ?>
                ...
                <div class="glass-card">
                    <h3 class="card-title" style="color: var(--secondary); font-size: 1.25rem; font-weight: 800; display: flex; align-items: center; gap: 0.5rem; margin-bottom: 1rem;">
                        📊 <?php echo e(__('Registration Status')); ?>
                    ...
                    <div style="margin-bottom: 1.25rem;">
                        <div style="display: flex; justify-content: space-between; font-size: 0.85rem; font-weight: 600; color: var(--text-muted); margin-bottom: 0.35rem;">
                            ...
                            <span style="color: var(--text-main);"><?php echo e($verifiedCount); ?> / <?php echo e($tournament->max_entries); ?> Slot (<?php echo e($filledPercent); ?>%)</span>
                        </div>
                        <div class="modern-progress-container">
                            <div class="modern-progress-bar" style="width: <?php echo e($filledPercent); ?>%"></div>
                        </div>
                    </div>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 0.5rem;">
                        <div class="minimal-list-item">
                            ...
                            <span style="font-weight: 700; color: var(--text-main); font-size: 0.95rem;">Rp <?php echo e(number_format($tournament->price_per_slot, 0, ',', '.')); ?></span>
                        </div>
                        <div class="minimal-list-item">
                            <span style="color: var(--text-muted); font-size: 0.9rem;">Maksimal Slot per Pemain</span>
                            <span style="font-weight: 700; color: var(--text-main); font-size: 0.95rem;"><?php echo e($tournament->max_slot_per_player); ?></span>
                        </div>
                        <div class="minimal-list-item">
                            <span style="color: var(--text-muted); font-size: 0.9rem;">Slot Tersedia</span>
                            <span style="font-weight: 700; color: var(--primary); font-size: 0.95rem;"><?php echo e($availSlots); ?> Slot</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); margin-bottom: 3rem; gap: 1.75rem;">
                ...
                <div class="glass-card" style="display: flex; flex-direction: column; justify-content: flex-start;">
                    ...
                    <div class="soft-well" style="max-height: 160px; overflow-y: auto; flex-grow: 1; padding: 0.75rem 1rem;">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $baganLiveMatches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $match): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php
                            ...
                            <div class="minimal-list-item" style="font-size: 0.85rem;">
                                <span>[ <?php echo e($roundName); ?> ] <?php echo e($homeLabel); ?> vs <?php echo e($awayLabel); ?></span>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($match['status'], ['completed', 'walkover'])): ?>
                                    <strong style="color: var(--primary);"><?php echo e($homePart['goals_scored']); ?> - <?php echo e($awayPart['goals_scored']); ?></strong>
                                <?php else: ?>
                ...
                <div class="glass-card" style="display: flex; flex-direction: column; justify-content: flex-start;">
                    ...
                    <div class="soft-well" style="max-height: 160px; overflow-y: auto; flex-grow: 1; padding: 0.75rem 1rem;">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $topScorers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <div class="minimal-list-item" style="font-size: 0.85rem;">
                                <span><?php echo e($index + 1); ?>. <?php echo e($row->player->name); ?> <span style="font-size: 0.75rem; color: var(--text-muted);">(<?php echo e($row->total_entries); ?> slot)</span></span>
                                <span style="font-weight: 700; color: var(--text-main);">
                                    <?php echo e($row->total_goals_scored); ?> gol
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($row->active_entries_count > 0): ?>
                                        🔥
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </span>
                            </div>
                ...
                <div class="glass-card" style="display: flex; flex-direction: column; justify-content: flex-start;">
                    ...
                    <div class="soft-well" style="max-height: 160px; overflow-y: auto; flex-grow: 1; padding: 0.75rem 1rem;">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $popularClubsCombined; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($index === 0): ?>
                                <div class="minimal-list-item" style="font-size: 0.85rem;">
                                    <span>1. <?php echo e($row->club->name ?? 'Unknown'); ?></span>
                                    <strong style="color: var(--secondary);"><?php echo e($row->usage_count); ?>x</strong>
                                </div>
                            <?php elseif($index === 1): ?>
                                <div class="minimal-list-item" style="font-size: 0.85rem;">
                                    <div style="display: flex; gap: 1rem; width: 100%; justify-content: space-between;">
                                        <span>
                                            2. <?php echo e($row->club->name ?? 'Unknown'); ?> (<strong style="color: var(--secondary);"><?php echo e($row->usage_count); ?>x</strong>)
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($popularClubsCombined[2])): ?>
                                                &nbsp;&nbsp;·&nbsp;&nbsp;
                                                3. <?php echo e($popularClubsCombined[2]->club->name ?? 'Unknown'); ?> (<strong style="color: var(--secondary);"><?php echo e($popularClubsCombined[2]->usage_count); ?>x</strong>)
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        </span>
                                    </div>
                                </div>
                            <?php elseif($index > 2): ?>
                                <div class="minimal-list-item" style="font-size: 0.85rem;">
                                    <span><?php echo e($index + 1); ?>. <?php echo e($row->club->name ?? 'Unknown'); ?></span>
                                    <strong><?php echo e($row->usage_count); ?>x</strong>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <div style="color: var(--text-muted); text-align: center; padding: 1rem 0;">
            ...
            <div style="margin-bottom: 1.5rem;">
                <h3 style="font-size: 1.75rem; font-weight: 900; margin-bottom: 1.5rem; letter-spacing: -0.5px;">
                    <span class="gradient-text"><?php echo e(__('Tournament Dashboard')); ?></span>
                </h3>
            </div>
                ...
                <div style="margin-bottom: 2rem; overflow-x: auto;">
                    <div class="segmented-control">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $stages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button wire:click="selectStage(<?php echo e($stage->id); ?>)" 
                                    class="segmented-item <?php echo e($activeStageId == $stage->id ? 'active' : ''); ?>">
                ...
                <!-- Leaderboard & Match schedules -->                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2rem;">
                    ...
                    <div>
                        <h4 style="margin-bottom: 1.5rem; font-weight: 800; color: var(--accent); font-size: 1.1rem;">
                            📊 <?php echo e(__('Leaderboard & Top Scorer')); ?>
                        ...
                        <div class="table-container">
                            <table>
                                <thead>
                                    <tr>
                                        <th style="width: 60px; text-align: center;"><?php echo e(__('Rank')); ?></th>
                                        <th><?php echo e(__('Player')); ?></th>
                                        <th style="text-align: center;"><?php echo e(__('Matches')); ?></th>
                                        <th style="text-align: center;"><?php echo e(__('Wins')); ?></th>
                                        <th style="text-align: center;"><?php echo e(__('Goals')); ?></th>
                                        <th style="text-align: center;"><?php echo e(__('Streak')); ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $leaderboard; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td style="text-align: center; font-weight: 800; font-size: 1rem;">
                                                ...
                                                <?php elseif($index === 2): ?>
                                                    🥉
                                                <?php else: ?>
                                                    <span style="color: var(--text-muted);">#<?php echo e($row->rank_position ?? ($index + 1)); ?></span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </td>
                                            <td style="font-weight: 700;"><?php echo e($row->player->name); ?></td>
                                            <td style="text-align: center;"><?php echo e($row->total_matches_played); ?></td>
                                            <td style="text-align: center;"><?php echo e($row->total_wins); ?></td>
                                            <td style="text-align: center; color: var(--primary); font-weight: 700;"><?php echo e($row->total_goals_scored); ?></td>
                                            <td style="text-align: center;">
                                                <span style="font-size: 0.8rem; font-weight: 700; padding: 0.15rem 0.5rem; border-radius: 6px; background: rgba(57,211,83,0.1); color: var(--primary);">
                                                    🔥 <?php echo e($row->current_win_streak); ?>
                                    ...
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <tr>
                                            <td colspan="6" style="text-align: center; color: var(--text-muted);">
                                                <?php echo e(__('Belum ada statistik pertandingan.')); ?>
                    ...
                    <div>
                        <h4 style="margin-bottom: 1.5rem; font-weight: 700; color: var(--secondary);">
                            ⚔️ <?php echo e(__('Console Queue')); ?> & <?php echo e(__('Ongoing Matches')); ?>
                        ...
                        <div style="display: flex; flex-direction: column; gap: 1rem; padding-right: 0.5rem;">
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <div style="text-align: center; padding: 2rem 0; color: var(--text-muted); border: 1px dashed var(--border-color); border-radius: 12px; font-size: 0.9rem;">
                                    <?php echo e(__('Tidak ada antrean match aktif.')); ?>
...
<?php /**PATH C:\laragon\www\TurnamenPS\resources\views/livewire/tournament/show.blade.php ENDPATH**/ ?>