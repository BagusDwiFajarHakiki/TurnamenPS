    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem; margin-bottom: 1.5rem;">
            ...
            <div style="display: flex; flex-direction: column; gap: 0.75rem; margin-top: 0.5rem;">
                ...
                <div style="display: flex; align-items: center; gap: 0.75rem;">
                    ...
                    <div>
                        ...
                        <strong class="text-emerald-500" style="font-size: 1.1rem;"><?php echo e($juara1 ?: 'Belum ditentukan'); ?></strong>
                    </div>
                </div>
                ...
                <div style="display: flex; align-items: center; gap: 0.75rem;">
                    ...
                    <div>
                        ...
                        <strong class="text-gray-900 dark:text-white" style="font-size: 1.1rem;"><?php echo e($juara2 ?: 'Belum ditentukan'); ?></strong>
                    </div>
                </div>
                ...
                <div style="display: flex; align-items: flex-start; gap: 0.75rem;">
                    ...
                    <div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($juara3): ?>
                            <strong class="text-gray-900 dark:text-white"><?php echo e($juara3); ?></strong>
                        <?php else: ?>
        ...
        <div class="card" style="display: flex; flex-direction: column; gap: 1rem; border-top: 4px solid #3b82f6;">
            ...
            <div style="display: flex; flex-direction: column; gap: 0.35rem; margin-top: 0.5rem;">
                ...
                ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $topScorers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $ts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="text-gray-900 dark:text-white" style="display: flex; justify-content: space-between; font-size: 0.9rem; padding: 0.35rem 0; border-bottom: 1px solid rgba(156, 163, 175, 0.2);">
                        <span><?php echo e($idx + 1); ?>. <strong><?php echo e($ts->player->name); ?></strong></span>
                        <strong class="text-blue-500"><?php echo e($ts->total_goals_scored); ?> Gol</strong>
                    </div>
...
<?php /**PATH C:\laragon\www\TurnamenPS\resources\views/_partials/tournament-recap.blade.php ENDPATH**/ ?>