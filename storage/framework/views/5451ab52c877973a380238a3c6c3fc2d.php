<div class="container" style="max-width: 540px; padding-top: 4rem;">
    <div class="card" style="background: var(--bg-card); backdrop-filter: blur(15px); border-radius: 16px; border: 1px solid var(--border-color); padding: 2.5rem;">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isRegistered): ?>
            <div style="text-align: center; padding: 1.5rem 0;">
                <div style="font-size: 4rem; margin-bottom: 1.5rem;">🎉</div>
                <h2 style="font-size: 2rem; font-weight: 800; margin-bottom: 1rem; color: var(--accent);">
                    <?php echo e(app()->getLocale() == 'id' ? 'Registrasi Akun Berhasil!' : 'Account Created!'); ?>
                ...
                <div style="display: flex; gap: 1rem; justify-content: center;">
                    <a href="/login" class="btn btn-primary" style="padding: 0.75rem 2rem;"><?php echo e(__('Login')); ?></a>
                    <a href="/" class="btn btn-secondary" style="padding: 0.75rem 1.5rem;"><?php echo e(app()->getLocale() == 'id' ? 'Halaman Utama' : 'Home'); ?></a>
                </div>
            </div>
        <?php else: ?>
            <h2 style="margin-bottom: 2rem; font-weight: 800; font-size: 2.25rem; text-align: center;">
                <span class="gradient-text"><?php echo e(app()->getLocale() == 'id' ? 'Daftar Akun Pemain' : 'Register Player Account'); ?></span>
            </h2>

            <form wire:submit.prevent="register">
                <div class="form-group">
                    <label class="form-label" for="name"><?php echo e(app()->getLocale() == 'id' ? 'Nama Lengkap' : 'Full Name'); ?></label>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="form-group">
                    ...
                    <small style="color: var(--text-muted); font-size: 0.75rem; display: block; margin-top: 0.25rem;">
                        <?php echo e(app()->getLocale() == 'id' ? 'Gunakan format nomor HP Indonesia yang valid.' : 'Use a valid Indonesian phone number format.'); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="form-group" style="margin-bottom: 2rem;">
                    <label class="form-label" for="password_confirmation"><?php echo e(app()->getLocale() == 'id' ? 'Konfirmasi Password' : 'Confirm Password'); ?></label>
                ...
                <button type="submit" class="btn btn-primary" style="width: 100%; padding: 0.85rem; font-size: 1.1rem;">
                    <?php echo e(app()->getLocale() == 'id' ? 'Buat Akun Pemain' : 'Create Player Account'); ?>
            ...
            <p style="text-align: center; color: var(--text-muted); margin-top: 1.5rem; font-size: 0.9rem;">
                ...
                <a href="/login" style="color: var(--primary); text-decoration: none; font-weight: 600;"><?php echo e(__('Login')); ?></a>
            </p>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

    </div>
</div>
<?php /**PATH C:\laragon\www\TurnamenPS\resources\views/livewire/tournament/registration.blade.php ENDPATH**/ ?>