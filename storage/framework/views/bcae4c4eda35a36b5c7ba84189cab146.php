        ...
        <div style="margin-bottom: 3rem;">
            <div style="margin-bottom: 1.5rem;">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tournament->baganLiveMatches->isNotEmpty()): ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($playersInTournaments[$tournament->id])): ?>
                        <div style="display: flex; flex-direction: column; justify-content: center; align-items: center; gap: 0.5rem; margin-bottom: 1rem; width: 100%;">
                            <label for="playerHighlight_<?php echo e($tournament->id); ?>" style="font-size: 0.95rem; font-weight: 600; color: var(--text-main);">Sorot Pemain:</label>
                            <select wire:model.live="highlightedPlayers.<?php echo e($tournament->id); ?>" id="playerHighlight_<?php echo e($tournament->id); ?>" style="padding: 0.5rem 1rem; border-radius: 8px; border: 1px solid var(--border-color); background: var(--bg-surface); color: var(--text-main); font-size: 0.95rem; min-width: 200px;">
                                <option value="">-- Tampilkan Semua --</option>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $playersInTournaments[$tournament->id]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div style="width: 100%; overflow-x: auto; margin-bottom: 2rem;">
                <?php echo $__env->make('_partials.bracket-tree', [
            ...
            <div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($latestTournament->baganLiveMatches->isNotEmpty()): ?>
                    <h4 style="margin-top: 2rem; margin-bottom: 1.5rem; font-weight: 700; color: var(--primary); display: flex; justify-content: space-between; align-items: center;">
                        <span><?php echo e(__('Tournament Bracket')); ?></span>
                    </h4>
                    
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($playersInTournaments[$latestTournament->id])): ?>
                        <div style="display: flex; flex-direction: column; justify-content: center; align-items: center; gap: 0.5rem; margin-bottom: 1rem; width: 100%;">
                            <label for="playerHighlight_<?php echo e($latestTournament->id); ?>" style="font-size: 0.95rem; font-weight: 600; color: var(--text-main);">Sorot Pemain:</label>
                            <select wire:model.live="highlightedPlayers.<?php echo e($latestTournament->id); ?>" id="playerHighlight_<?php echo e($latestTournament->id); ?>" style="padding: 0.5rem 1rem; border-radius: 8px; border: 1px solid var(--border-color); background: var(--bg-surface); color: var(--text-main); font-size: 0.95rem; min-width: 200px;">
                                <option value="">-- Tampilkan Semua --</option>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $playersInTournaments[$latestTournament->id]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($p['id']); ?>"><?php echo e($p['name']); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </select>
                        </div>
